...
export const initialTasks: Task[] = [
  ...
  new Task(4, 'Git Collaboration', 'Collaborate on a Git repository.', 'Intern', 2,true,true),
  new Task(5, 'JavaScript Basics', 'Complete JavaScript basics tutorial.', 'Intern', 3,false,true),
